"""
UI Testing Framework for NL-to-SQL Strategy Comparison
Provides a safe testing interface to compare different strategies
"""
...
class NLToSQLTestingUI:
    """
    UI interface for testing and comparing NL-to-SQL strategies
    Allows safe evaluation without affecting production queries
    """
    
    def __init__(self, data_file_path: str = None, llm_interpreter=None):
        """
        Initialize the testing UI
        
        Args:
            data_file_path: Path to CSV data file for testing
            llm_interpreter: LLM interpreter for strategy 1
        """
