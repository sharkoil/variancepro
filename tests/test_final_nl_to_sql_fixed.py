...
Tests 10 diverse examples using comprehensive_sales_data.csv with the fixed final version
"""
...
from analyzers.enhanced_nl_to_sql_translator_final_fixed import EnhancedNLToSQLTranslator
...
def test_nl_query(translator: EnhancedNLToSQLTranslator, df: pd.DataFrame, query: str, expected_columns: List[str] = None) -> Dict[str, Any]:
    ...
    if expected_columns:
        ...
        if missing_cols:
            ...
            print(f"✅ All expected columns found or aliased")
